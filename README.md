...
- Solution URL: [Add solution URL here](https://www.frontendmentor.io/solutions/flip-clock-countdown-with-darklight-mode-using-react-and-tailwind-css-cRyZmTWQva)
- Live Site URL: [Add live site URL here](https://launch-countdown-timer-one-sandy.vercel.app/)

## My process

### Built with

- **Semantic HTML5 markup**: Properly using `main` and `footer` landmarks.
- **Tailwind CSS v4**: Utilizing the new `@theme` layer for advanced variable management.
- **React (Vite)**: For a fast, component-based architecture.
- **Custom Hooks**: Clean separation of theme and timer logic from the UI.
- **CSS 3D Transforms**: For the smooth flip clock animation.
